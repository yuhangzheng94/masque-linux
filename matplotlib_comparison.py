...
# 'test/tcp_large_file_cubic.txt','test/tcp_large_file_reno.txt']  # Add your file names here

# List of colors for each line
line_colors = ['red', 'blue', 'green', 'purple', 'orange', 'brown', 'red', 'blue','green','purple','orange', 'brown']  # Add your desired colors here
