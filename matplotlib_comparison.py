...
csv_files = ['test/masquerade_large_file_cubic_new.txt', 'test/masquerade_large_file_reno_new.txt','test/tcp_large_file_cubic.txt','test/tcp_large_file_reno.txt']  # Add your file names here
